                                  ...
                                  <Row className="align-items-center">
                                    ...
                                    <Col xs={8} sm={9}>
                                      <div className="d-flex align-items-center mb-1">
                                        <h5 className="mb-0 me-2">{record.recordId}</h5>
                                        <Badge bg="light" text="dark" className="me-2">{record?.date}</Badge>
                                      </div>
                                      <div>{record?.department}</div>
                                      <div className="text-muted">{record?.doctor}</div>
                                    </Col>
                                    ...
                                    <div className="mt-3">
                                      ...
                                      <div className="mt-3 d-flex justify-content-between">
                                        <div className="text-muted">
                                          <strong>Chuẩn đoán:</strong> {prescription.diagnosis}
                                        </div>
