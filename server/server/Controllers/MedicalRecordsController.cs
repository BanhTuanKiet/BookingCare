...
namespace Clinic_Management.Controllers
{
    ...
    public class MedicalRecords : ControllerBase
    {
        ...
        (
            ...
            IMedicalRecord medicalRecordService, 
        ...
        {
            var appointment = await _appointmentService.GetAppointmentById(appointmentId) ?? throw new ErrorHandlingException(400, "Không tìm thấy lịch hẹn!");
